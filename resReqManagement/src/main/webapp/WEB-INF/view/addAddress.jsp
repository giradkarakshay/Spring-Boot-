...
<body style="text-align: center;">
	...
	<main role="main" class="container" >
		...
		<div class="wrap-login100 p-l-55 p-r-55 p-t-65 p-b-50" style="background-color: aqua; opacity:0.9;">
				<form class="login100-form validate-form" action="addAddress.ds" method="post">
					<span class="login100-form-title p-b-33">
						Add Address: 
					</span>
						<p>${msg}</p>
					<div class="wrap-input100 validate-input" data-validate = "name is required: xyz">
						<input class="input100" type="text" name="addressLine1" placeholder="Address Line 1">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
					
					<div class="wrap-input100 validate-input" data-validate = "name is required: xyz">
						<input class="input100" type="text" name="addressLine2" placeholder="Address Line 2">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
					...
					<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
						<input class="input100" type="text" name="pincode" placeholder="Pin Code">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
