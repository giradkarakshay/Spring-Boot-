		    			...
		    			<tr style="color: red;">	
         				...
         				<c:forEach items="${skillList}" var="skill">
        	   			<tr>
        	   				...
        	   				<a href="deleteSkill/${skill.skillId}.ds">Delete</a>&nbsp;<a href="updateSkill/${skill.skillId}.ds">Update</a>
            			</tr>
            			</c:forEach>
        			</table>
        			<br><hr><br>
		    			...
		    			<tr style="color: red;">
         				...
         				<c:forEach items="${experienceList}" var="experience">
        	   			<tr>
                			...
                			<a href="deleteExperience/${experience.workExpId}.ds">Delete</a>&nbsp;<a href="updateExperience/${experience.workExpId}.ds">Update</a>
            			</tr>
            			</c:forEach>
        			</table>
        			<br><hr><br>
		    			...
		    			<tr style="color: red;">
         				...
         				<c:forEach items="${educationList}" var="education">
        	   			<tr>
                			...
                			<a href="deleteEducation/${education.educationDetailId}.ds">Delete</a>&nbsp;<a href="updateEducation/${education.educationDetailId}.ds">Update</a>
            			</tr>
            			</c:forEach>
        			</table>
        			<br><hr><br>
